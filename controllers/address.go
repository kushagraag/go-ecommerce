...
func AddAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// store address from client/api req
		...
		// find all existing addresses for particular user
...
// user can have 2 addresses only. at 0 is home address and at 1 is work address
...
// 1. check user id
// 2. set address slice to empty
// 3. create filter, create update obj, update collection
